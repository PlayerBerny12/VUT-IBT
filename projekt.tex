...
\projectinfo{
  ...
  abstract.cs={
    ...
    Z analýzy trhu vyplynulo, že na trhu je velký výběr aplikací, ale rozdíly mezi nimi jsou relativné velké. Na základě požadavků a stanovené komunikace s validovaným datovým
    uložištěm byla navržena a implementována aplikace pro systém \mbox{GNU/Linux}. Testování apliakce probíhalo na dvou vybrancýh Linuxových distribucích
